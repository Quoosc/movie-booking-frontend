...
function RoomModal({
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center px-4 py-6">
      ...
      />
      {/* content */}
      <div className="relative z-50 w-full max-w-lg rounded-3xl bg-gradient-to-br from-[#1a0033]/95 via-[#0b001f] to-black/95 border border-white/15 shadow-2xl overflow-hidden">
