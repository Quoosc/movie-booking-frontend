  ...
  return (
    <header
      className="
        ...
        bg-gradient-to-b from-[#050018]/98 via-[#050018]/96 to-[#050018]/94
        backdrop-blur-xl
        shadow-[0_8px_26px_rgba(0,0,0,0.7)]
      "
    >
      {/* neon glow mờ phía trên */}
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[86px] bg-[radial-gradient(circle_at_top,#7b5cff33,transparent)]" />
