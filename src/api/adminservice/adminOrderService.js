...
return res.data || res;// swagger: trả BookingResponse trực tiếp
}
...
return res.data || res;// swagger: trả List<PaymentResponse>
}
...
return res.data || res;// swagger: InitiatePaymentResponse
}
...
return res.data || res;// swagger: PaymentResponse
}
...
return res.data || res;// swagger: IpnResponse
}
